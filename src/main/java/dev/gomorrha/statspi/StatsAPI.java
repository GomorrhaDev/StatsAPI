...
public class StatsAPI extends JavaPlugin{
    ...
    public void onEnable(){
        ...
        saveConfig();
        mysql = new MySQL(getConfig().getString("mysql.host") + ":" + getConfig().getString("mysql.port") , getConfig().getString("mysql.user") , getConfig().getString("mysql.password"));
